        ...
        if(tableFlag==false)        //初次打开时table不存在
             {
                ...
                query.exec("insert into dish values(301, 3, '澳洲龙虾', 0, 0, 85, 'null', 1)");
                query.exec("insert into dish values(302, 3, '象拔蚌', 0, 0, 50, 'null', 1)");
                ...
                query.exec("insert into dish values(307, 3, '文蛤', 0, 0, 40, 'null', 1)");
                ...
                query.exec("insert into dish values(406, 4, '啤酒鸭', 0, 0, 86, 'null', 1)");
                query.exec("insert into dish values(501, 5, '苦瓜', 0, 0, 16, 'null', 1)");
                query.exec("insert into dish values(502, 5, '西葫芦', 0, 0, 12, 'null', 0)");
                query.exec("insert into dish values(503, 5, '青椒土豆丝', 0, 0, 10, 'null', 0)");
                query.exec("insert into dish values(504, 5, '蚝油生菜', 0, 0, 12, 'null', 1)");
                ...
                query.exec("insert into dish values(701, 7, '小笼包', 0, 0, 28, 'null', 1)");
                ...
                query.exec("insert into dish values(802, 8, '碧螺春', 0, 0, 50, 'null', 1)");
                query.exec("insert into dish values(803, 8, '茅台', 0, 0, 2000, 'null', 1)");
                query.exec("insert into dish values(804, 8, '五粮液', 0, 0, 1100, 'null', 1)");
                //===================================================
