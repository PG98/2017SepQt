        ...
        if(tableFlag==false)        //初次打开时table不存在
             {
                ...
                query.exec("insert into waiter values(201, -1, -1, 5, 5)");
                query.exec("insert into waiter values(202, -1, -1, 5, 5)");
                query.exec("insert into waiter values(203, -1, -1, 5, 5)");
                query.exec("insert into waiter values(204, -1, -1, 5, 5)");
                query.exec("insert into waiter values(205, -1, -1, 5, 5)");
                //===================================================
