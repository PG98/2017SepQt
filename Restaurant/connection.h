        ...
        if(tableFlag==false)        //初次打开时table不存在
             {
                ...
                query.exec("insert into diningtable values(1, 6, 0, 0, 0, -1, 0, -1)");
                query.exec("insert into diningtable values(2, 6, 0, 0, 0, -1, 0, -1)");
                query.exec("insert into diningtable values(3, 6, 0, 0, 0, -1, 0, -1)");
                query.exec("insert into diningtable values(4, 10, 0, 0, 0, -1, 0, -1)");
                query.exec("insert into diningtable values(5, 10, 0, 0, 0, -1, 0, -1)");
                query.exec("insert into diningtable values(6, 10, 0, 0, 0, -1, 0, -1)");
                query.exec("insert into diningtable values(7, 10, 0, 0, 0, -1, 0, -1)");
                query.exec("insert into diningtable values(8, 15, 0, 0, 0, -1, 0, -1)");
                query.exec("insert into diningtable values(9, 15, 0, 0, 0, -1, 0, -1)");
                query.exec("insert into diningtable values(10, 15, 0, 0, 0, -1, 0, -1)");
                //===================================================
                query.exec("create table waiter (id int primary key, table1 int, table2 int, comment real, history int)");
                query.exec("insert into waiter values(201, -1, -1, 5.0, 5)");
                query.exec("insert into waiter values(202, -1, -1, 5.0, 5)");
                query.exec("insert into waiter values(203, -1, -1, 5.0, 5)");
                query.exec("insert into waiter values(204, -1, -1, 5.0, 5)");
                query.exec("insert into waiter values(205, -1, -1, 5.0, 5)");
                //===================================================
